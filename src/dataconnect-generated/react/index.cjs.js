const { listProductsRef, createProductRef, listInspectionLogsRef, updateProductRef, connectorConfig } = require('../index.cjs.js');
...
exports.useListInspectionLogs = function useListInspectionLogs(dcOrOptions, options) {
  const { dc: dcInstance, options: inputOpts } = validateReactArgs(connectorConfig, dcOrOptions, options);
