...
```ts
import { useListProducts, useCreateProduct, useListInspectionLogs, useUpdateProduct } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useListInspectionLogs();
...
```js
import { listProducts, createProduct, listInspectionLogs, updateProduct } from '@dataconnect/generated';
